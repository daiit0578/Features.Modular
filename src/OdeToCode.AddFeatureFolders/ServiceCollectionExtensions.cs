    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IMvcBuilder AddAreaFeatureFolders(this IMvcBuilder services, AreaFeatureFolderOptions options)
        {
            services.AddRazorOptions(o =>
            {
                ...
                // View in Feature Name
                o.AreaViewLocationFormats.Add(options.FeatureFolderName + @"\{1}\{0}.cshtml");
                // View in Feature  / View name
                o.AreaViewLocationFormats.Add(options.FeatureFolderName + @"\{1}\Views\{0}.cshtml");

                o.AreaViewLocationFormats.Add(@"Features\HDVietNam\{1}\{0}.cshtml");
